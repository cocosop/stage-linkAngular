...
export default class PostulationsComponent implements OnInit{
  displayedColumns: any[] = ["datePostulation", "titreStage", "statut"];
  dataSource: MatTableDataSource<Postulation>;

  @ViewChild(MatPaginator) paginator!: MatPaginator;
  email: string;
  postulation: Postulation[] = [];

  constructor(public service:PostulationService, public dialog: MatDialog) {
    this.dataSource = new MatTableDataSource<Postulation>([]);
